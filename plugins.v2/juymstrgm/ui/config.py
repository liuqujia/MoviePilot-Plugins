...
class UIConfig:
    ...
    def get_form() -> Tuple[List[dict], Dict[str, Any]]:
                ...
                'content': [
                    ...
                    # 聚影说明
                    {
                        ...
                        'content': [{
                            'component': 'VCol',
                            'props': {'cols': 12},
                            'content': [{'component': 'VAlert', 'props': {'type': 'info', 'variant': 'tonal', 'text': '聚影(JuYing) 资源查询：基于TMDB ID精准查询115网盘资源，准确度更高'}}]
                        }]
                    },
                    # 聚影 配置
                    {
                        ...
                        'content': [
                            {'component': 'VCol', 'props': {'cols': 12, 'md': 4},
                             'content': [{'component': 'VSwitch', 'props': {'model': 'juying_enabled', 'label': '启用 聚影'}}]},
                            {'component': 'VCol', 'props': {'cols': 12, 'md': 4},
                             'content': [{'component': 'VTextField', 'props': {'model': 'juying_app_id', 'label': '聚影 APP ID', 'placeholder': '请输入 APP ID'}}]},
                            {'component': 'VCol', 'props': {'cols': 12, 'md': 4},
                             'content': [{'component': 'VTextField', 'props': {"clearable": True, 'model': 'juying_api_key', 'label': '聚影 API Key', 'type': 'password', 'placeholder': '请输入 API Key'}}]}
                        ]
                    },
                    # 聚影 Base URL
                    {
                        ...
                        'content': [
                            {'component': 'VCol', 'props': {'cols': 12, 'md': 6},
                             'content': [{'component': 'VTextField', 'props': {'model': 'juying_base_url', 'label': '聚影 API 地址', 'placeholder': 'https://share.huamucang.top'}}]}
                        ]
                    },
                    # HDHive说明
                    {
        ...
        default_config = {
            ...
            "juying_app_id": "",
            "juying_api_key": "",
            "juying_base_url": "https://share.huamucang.top",
                        ...
                        'content': [
                            {
                                ...
                                'content': [{
                                    ...
                                    'events': {
                                        'click': {
                                            'api': f'/plugin/JuyingSub/sync_subscribes?apikey={settings.API_TOKEN}',
                                            'method': 'get'
                                        }
                                    }
                                }]
                            },
                            {
                                ...
                                'content': [{
                                    ...
                                    'events': {
                                        'click': {
                                            'api': f'/plugin/JuyingSub/clear_history?apikey={settings.API_TOKEN}',
                                            'method': 'post'
                                        }
                                    }
                                }]
