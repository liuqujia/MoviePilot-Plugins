...
class P115StrgmSubKirito(_PluginBase):
    """115网盘订阅追更插件 Kirito版"""

    # 插件名称
    plugin_name = "115网盘订阅追更 Kirito版"
    # 插件描述
    plugin_desc = "修复Cookie验证兼容性，结合MoviePilot订阅功能，自动搜索115网盘资源并转存缺失的电影和剧集。"
    # 插件图标
    ...
    # 插件配置项ID前缀
    plugin_config_prefix = "p115strgmsub_kirito_"
    plugin_order = 20
    auth_level = 1
